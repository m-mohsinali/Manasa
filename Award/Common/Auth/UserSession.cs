...
namespace Award.Web.Common.Auth
{
    public class UserSession : IUserSession
    {
        ...
        public bool IsQSM => IsInRole("QualitySectionManager");
        public bool IsEndUser => IsInRole("EndUser");
        public bool IsAuditManager => IsInRole("AuditManager");
        public bool IsAuditor => IsInRole("Auditor");
        public bool IsJury => IsInRole("Jury");
